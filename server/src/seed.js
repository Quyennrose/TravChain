...
const [admin, travelerA, travelerB, partnerA, partnerB] = await User.insertMany([
  ...
  { name: 'Central Vietnam Partner', email: 'partner@travchain.vn', passwordHash, role: 'partner', companyName: 'Central Vietnam Travel Co.', acceptsInternationalCard: true, settlementCurrency: 'VND' },
  { name: 'Local Culture Partner', email: 'local@travchain.vn', passwordHash, role: 'partner', companyName: 'Local Culture Studio', acceptsInternationalCard: true, settlementCurrency: 'USD' },
]);
